...
One approach to encode genre was to use one-hot encoding. To achieve this, we created new columns for each of the genres. For each movie, the value is 1 if the move belongs to that particular genre, 0 otherwise.
