...
\begin{center}
	\begin{tabular}{llll}
		...
		\hline
		\multirow{4}{*}{Variance Avg} & Numeric &  0.6648 & \textbf{0.2752}\\
		& OneHotEnc & 0.6641 & 0.2691 \\
		& Word2Vec Genres  & \textbf{0.6635} & \textbf{0.2752} \\
		& Probabilistic & 0.6640 & 0.2724 \\
		\hline
		\multirow{4}{*}{Simple Avg} & Numeric & 0.6653 & \textbf{0.2742}\\
		& OneHotEnc & 0.6647 & 0.2665 \\
		& Word2Vec Genres & \textbf{0.6643} & 0.2733 \\
