...
\end{align*}
where the $\theta = \{\ell,\sigma^{2}_{n},...\}$ are the hyper-parameters which can be tuned by Markov Chain Monte Carlo methods or through Bayesian Optimisation (Neal 1997; Sundararajan and Keerthi 2001). Learning the hyperparameters is possible as the log likelihood partial derived, letting $\mathcal{Q}$ to be 
$K + \sigma^{2}_{n}I$, 
